...
router.post('/signup',  async function(req, res, next) {
 try {
  ...
  const driver=await Driver.create({...req.body, password})
  await sendVerificationEmail(driver.id,driver.email)
...
// router.get('/66',  async function(req, res, next) {
//   try {
  ...
  try{
     ...
     //console.log(${currenturl} + "api/driver/verify/" + _id );
      ...
      const mailOptions = {
          ...
          <p> This Link <b> expires in 6 hours </p> </p> <p> Press <a href=${currenturl + "driver/verify/" + _id + "?hash=" + uniqueString}> here </a> to proceed </p>`
